                            ...
                            <%@ page import="Service.AccountService" %>
                                <%@ page contentType="text/html;charset=UTF-8" language="java" %>
                                    ...
                                    <body>
                                        ...
                                        <% Account account=(Account) session.getAttribute("account"); Double
                                            productRating=(Double) request.getAttribute("productRating"); ProductService
                                            ...
                                            request.getAttribute("feedbackAndRatingService"); Product
                                            selectedProduct=(Product) request.getAttribute("selectedProduct"); String
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <%--Feedback Form--%>
                                                                <form id="feedbackForm" action="./submitFeedback"
                                                                    ...
                                                                    <div class="button-container">
                                                                        <button type="submit"
                                                                            ...
                                                                            id="submitButton">Gửi phản hồi</button>
                                                                    </div>
                                                                </form>
                                                                ...
                                                                <%-- Comments Section --%>
                                                                    ...
                                                                    <% if (comments !=null && !comments.isEmpty()) { for
